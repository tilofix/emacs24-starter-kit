...
#+BEGIN_SRC emacs-lisp :tangle yes
  (custom-set-variables
   '(package-selected-packages
     (quote
      (python-mode yasnippet yang-mode yaml-mode rust-mode ruby-mode restclient powershell ob-ipython markdown-mode magit json-mode helm-core gnuplot git-rebase-mode git-commit-mode gh elnode ein))))

        ...
        (org-babel-load-file
         (if header-or-tag
             (let* ((base (file-name-nondirectory file))
               ...
               partial-file)
           file)
         t ;; COMPILE the tangled Emacs Lisp file to byte-code before it is loaded.
         )))
  #+end_src
...
#+begin_src emacs-lisp
  (flet ((sk-load (base)
           (let* ((path          (expand-file-name base starter-kit-dir))
             ...
             (cond
              ((file-exists-p encrypted-org) (org-babel-load-file encrypted-org t))
              ((file-exists-p encrypted-el)  (load encrypted-el))
              ((file-exists-p literate)      (org-babel-load-file literate t))
